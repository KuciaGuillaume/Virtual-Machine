...
if (string_count("PIN", TAG) > 0) {
	...
	if (PARENT.PIN) {
		...
		var class = [PARENT.PIN, PARENT.CREATE_WINDOW_IMAGE, PARENT.CREATE_WINDOW_OBJECT, PARENT.WINDOW_TAG, PARENT.CREATE_WINDOW_ICON, PARENT.CREATE_WINDOW_NAME, PARENT.CREATE_WINDOW_TOP];
...
if (string_count("WINDOW_ME", TAG) > 0)
	CreateWindow(PARENT.CREATE_WINDOW_IMAGE, PARENT.CREATE_WINDOW_OBJECT,PARENT.CREATE_WINDOW_TAG, PARENT.CREATE_WINDOW_ICON, PARENT.CREATE_WINDOW_NAME, PARENT.CREATE_WINDOW_TOP);
