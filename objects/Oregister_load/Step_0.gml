...
if (STATE == 0) {
	// CREATE REGISTER
	CreateObjects(960, 540, "Cursor", Ocursor, "CURSOR", "REGISTER_CURSOR", ["NULL"]);
...
if (STATE == 1) {
	...
	CreateObjectSprite(140, 397, "Gp2", Sicon_box, OJustGUI, "IMAGE", "GUI_ICON_BOX", ["NULL"]);
	CreateObjectSprite(440, 397, "Gp2", Sbackground_box, OJustGUI, "IMAGE", "GUI_BACKGROUND_BOX", ["NULL"]);
