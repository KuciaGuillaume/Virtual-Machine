...
if ((WINDOW != undefined && instance_exists(WINDOW)) && !CLOSE && string_count("TERMINAL", WINDOW.TAG) ) {
	...
	if (!CREATE) {
		...
		WINDOW.list_objects = addtolist(CreateButtonBox(x, y, S_terminal_button, Obox, AutoLanguage("Help"), WINDOW.LAYERS[0], WINDOW.LAYERS[1], Arial10, c_white, TAG + "TERMINAL_HELP", [["CENTERED"], undefined]), WINDOW.list_objects);
		WINDOW.list_objects = addtolist(CreateButtonBox(x, y, S_terminal_button, Obox, AutoLanguage("History"), WINDOW.LAYERS[0], WINDOW.LAYERS[1], Arial10, c_white, TAG + "TERMINAL_HISTORY", [["CENTERED"], undefined]), WINDOW.list_objects);
		WINDOW.list_objects = addtolist(CreateButtonBox(x, y, S_terminal_button, Obox, AutoLanguage("Clear"), WINDOW.LAYERS[0], WINDOW.LAYERS[1], Arial10, c_white, TAG + "TERMINAL_CLEAR", [["CENTERED"], undefined]), WINDOW.list_objects);
