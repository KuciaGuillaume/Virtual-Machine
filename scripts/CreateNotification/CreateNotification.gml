...
function CreateNotification(ICON, TITLE, DESCRIPTION, TAG) {
	...
	var description = AddText(X, Y + 18, DESCRIPTION, Arial10, c_white, "Notifications_Gp1", TAG + "DESCRIPTION", [["CENTERED"], ["FADE_IN", 0.000001], "NULL"]);
