...
function CreateObjectSprite(x, y, Layer, sprite, object, type, tag, option){
	...
	global.OBJECTS = addtolist(CLASS, global.OBJECTS);
	if (type == "BUTTON" || type == "TEXT_BUTTON" || type == "INFO" || type == "BUTTON-NO-HAND" || type == "EMPT_BUTTON-NO-HAND" || type == "EMPT_BUTTON" || type == "CHECKER")
		global.BUTTONS = addtolist(CLASS, global.BUTTONS);
	return Isobject;
}
...
function DestroyObject(TAG) {
	...
	if (type == "BUTTON" || type == "TEXT_BUTTON" || type == "CHECKER" || type == "INFO" || type == "BUTTON-NO-HAND" || type == "EMPT_BUTTON-NO-HAND" || type == "EMPT_BUTTON") {
		var e = 0;
