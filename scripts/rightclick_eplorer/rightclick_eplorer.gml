...
function rightclick_explorer(PARENT, FOLDERS, LAYERS) {
	...
	if (on_folders == "NULL") {
		PARENT.EXPLORER_SLIDER = CreateEmptyRound(mouse_x - 10, mouse_y - 5, c_white, 200, 31, LAYERS[2], PARENT.TAG + "EXPLORER_SLIDERS", [["FADE_IN", 0.000005], ["SLIDE", 0.0001], "NULL"]);
		var button = CreateButtonBox(mouse_x + 90, mouse_y + 11, S_new_folder, OboxText, "Create new folder", LAYERS[3], LAYERS[4], Arial10, c_black, PARENT.TAG + "NEW_EXPLORERS_FOLDERS", [["CENTERED"], ["FADE_IN", 0.000005], ["SLIDE", 0.0001],  "NULL"]);
		...
		PARENT.EXPLORER_SLIDER = CreateEmptyRound(mouse_x - 10, mouse_y - 25, c_white, 200, 56, LAYERS[2], PARENT.TAG + "EXPLORER_SLIDERS", [["FADE_IN", 0.000005], ["SLIDE", 0.0001], "NULL"]);
		var button = CreateButtonBox(mouse_x + 90, mouse_y + 16, S_rename_folder, OboxText, "Rename folder", LAYERS[3], LAYERS[4], Arial10, c_black, PARENT.TAG + "RENAME_EXPLORERS_FOLDERS", [["CENTERED"], ["FADE_IN", 0.000005], ["SLIDE", 0.0001],  "NULL"]);
		var deleted = CreateButtonBox(mouse_x + 90, mouse_y - 8, S_delete_folder, OboxText, "Delete folder", LAYERS[3], LAYERS[4], Arial10, c_black, PARENT.TAG + "DELETE_EXPLORERS_FOLDERS", [["CENTERED"], ["FADE_IN", 0.000005], ["SLIDE", 0.0001],  "NULL"]);
		button.NUM_LINKED = i;
		button.PARENT = PARENT.EXPLORER_SLIDER;
