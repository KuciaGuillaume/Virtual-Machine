...
function rightclick_explorer(PARENT, FOLDERS, LAYERS) {
	...
	if (on_folders == undefined) {
		...
		var button = CreateButtonBoxType(mouse_x + 90, mouse_y + 11, S_new_folder, OboxText, "Create new folder", LAYERS[3], LAYERS[4], Arial10, c_black, PARENT.TAG + "NEW_EXPLORERS_FOLDERS", [["BACK", 60], ["FADE_IN", 0.000005], ["SLIDE", 0.0001],  undefined], "BUTTON-NO-HAND");
		...
		var button = CreateButtonBoxType(mouse_x + 90, mouse_y + 25, S_rename_folder, OboxText, "Rename folder", LAYERS[3], LAYERS[4], Arial10, c_black, PARENT.TAG + "RENAME_EXPLORERS_FOLDERS", [["BACK", 60], ["FADE_IN", 0.000005], ["SLIDE", 0.0001],  undefined], "BUTTON-NO-HAND");
		var deleted = CreateButtonBoxType(mouse_x + 90, mouse_y - 23, S_delete_folder, OboxText, "Delete folder", LAYERS[3], LAYERS[4], Arial10, c_black, PARENT.TAG + "DELETE_EXPLORERS_FOLDERS", [["BACK", 60], ["FADE_IN", 0.000005], ["SLIDE", 0.0001],  undefined], "BUTTON-NO-HAND");
		var open = CreateButtonBoxType(mouse_x + 90, mouse_y + 1, S_Desk_open_explorer, OboxText, "Open in another explorer", LAYERS[3], LAYERS[4], Arial10, c_black, PARENT.TAG + "EXPLORERS_OPEN_IN_ANOTHER", [["BACK", 60], ["FADE_IN", 0.000005], ["SLIDE", 0.0001],  undefined], "BUTTON-NO-HAND");
		button.NUM_LINKED = i;
		button.PARENT = PARENT.EXPLORER_SLIDER;
